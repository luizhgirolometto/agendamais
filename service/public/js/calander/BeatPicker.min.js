...
BeatPicker.prototype = {
        ...
        var c = this.by(a),
            ...
            g = {
                ...
                _topAutoCommon: function () {
                    var a; + (this._topCommon() + f.k.outerHeight() - $(window).scrollTop()) > $(window).height() ? (a = $(window).height() + $(window).scrollTop() - f.k.outerHeight(), $(window).height() <
    ...
    au: function (a) {
        a = $(a.originalEvent.currentTarget);
        var b = a.data("date"),
            c = this.bf(b),
            d = {};
        this.selectionRule.single ? (this.l && this.cl(this.l), this.m = new Date(b.getTime()), this.dateInputNode.val(c), this.l = a, !this.view.alwaysVisible && this.hide(), this.ck(this.l), d = {
            ...
            !this.br(this.o, this.r, this.t) ? (d = {
                ...
                toDate: this.q
            }), this.cq(this.events.select, d), this.b.val(c), this.cd() && !this.n && this.show(this.dateInputNode)), this.ck(a), this.n && this.q && this.co(this.n,
                this.q)) : (this.r = this.q ? new Date(this.q.getTime()) : null, this.o = this.n ? new Date(this.n.getTime()) : null))
    },
    av: function (a, b) {
        if (a)
            if (b === this.y.briefDate)(a || this._currentIndicator).text(this.monthsFull[this.currentDate.getMonth()] + " " + this.currentDate.getFullYear());
    ...
    on: function (a, b, c) {
        a && "string" === typeof a &&
            b && (!this.aa[a] && (this.aa[a] = []), this.aa[a].push({
                func: b,
                scope: c ? c : this.k
            }))
    },
