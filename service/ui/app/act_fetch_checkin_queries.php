...
<tr style="display:none" class="datas checkin">
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<input type="text" name="reason" maxlength="30" placeholder="Reason for Visit" value="<?php echo $Data[reason];?>"/>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-6 field">
		<input type="button" value="submit" class="save1 submit_button " />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-6 field">
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<input type="text" name="concerns" maxlength="30" placeholder="Reason for Visit" value="<?php echo $Data[concerns];?>"/>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-6 field">
		<input type="button" value="submit" class="save1 submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<div class="drop-select">
			<select multiple="multiple"  class="SlectiB" name="allergies" id="allergies">
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<div class="drop-select">
			<select multiple="multiple"  class="SlectiBo" name="history" id="history">
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<div class="drop-select">
			<select multiple="multiple"  class="SlectiBoxx"  name="history" id="history">
...
<td colspan="3">
	<div class="row">
		<div class="col-md-6 col-sm-6 col-xs-12 field">
			<input type="text" name="concerns" maxlength="30" placeholder="Reason for Visit" value="<?php echo $Data[hosp];?>"/>
		</div>
		<div class="col-md-6 col-sm-6 col-xs-12 field">
			...
			<div class="col-md-4 col-sm-4 col-xs-12 padding-0">
				<div class="drop-select">
					<select name="Surgeries_Year" id="Surgeries_Year">
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<input type="text" name="alcohol" maxlength="30" placeholder="# alcohol drinks/week" value="<?php echo $Data[alcohol]; ?>"/>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-6 field">
		<input type="button" value="submit" class="save1 submit_button " />
	</div>
...
<tr style="display:none" class="datas checkin">
<td colspan="3">
	<div class="col-md-3 col-sm-3 col-xs-12 field">
		<div class="drop-select">
	...
	<div class="col-md-3 col-sm-3 col-xs-12 field">
		<input type="text" name="npacks" maxlength="30" value="<?php echo $Data[npacks]; ?>" placeholder="# packs/day"/>
	</div>
	<div class="col-md-3 col-sm-3 col-xs-12 field">
		<input type="text" name="packs" maxlength="30" placeholder="# packs/day" value="<?php echo $Data[packs]; ?>"/>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-6 field">
		<input type="button" value="submit" class="save1 submit_button " />
	</div>
...
<td colspan="3">
	...
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<input type="text" name="type" maxlength="30" placeholder="types" value="<?php echo $Data[type]; ?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<input type="text" name="wtype" maxlength="30" placeholder="# times/week" value="<?php echo $Data[wtype]; ?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-6 field">
		<input type="button" value="submit" class="save1 submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12 field">
		<input type="text" name="caffeine" maxlength="30" placeholder="# caffeine/day" value="<?php echo $Data[caffeine]; ?>"/>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-6 field">
		<input type="button" value="submit" class="save1 submit_button " />
	</div>
...
<tr style="display:none" class="datas checkin">
<td colspan="3">
	<div class="col-md-6 col-sm-4 col-xs-12 field">
		<div class="drop-select">
			<select name="excr" id="excr">
	...
	<div class="col-md-6 col-sm-4 col-xs-12 field">
		<input type="text" name="nexcr" maxlength="30" placeholder="# times/week" value="<?php echo $Data[nexcr]; ?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-6 field">
		<input type="button" value="submit" class="save1 submit_button " />
	</div>
...
<div class="conform_button conform_queries_click lg_btn col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-4 col-xs-offset-0 col-xs-12">save</div>