     ...
     function calendar_html($value,$columns,$Day,$date,$s,$key){
        ...
        $calendar_html = '';
                ...
                foreach ($value[$day_C]['working_time'] as $ve_key => $ve_value) {
                    ...
                    if($ve_key==4){
                        $calendar_html .= '<li  class="bottomBorder moreClk'.$key.' more '.$cls_hi.' sss" value="'.$key.'"  > <div class="sch-slotex">
                            More
                            </div> </li>';
                    }elseif($ve_value==end($value[$day_C]['working_time'])){
                        $calendar_html .= '<li class="last disabled less '.$cls_hi.' sss'.$key.'" value="'.$key.'" > <div class="sch-slotex">Less </div></li>';
                    }
                    elseif(is_array($value['vacation_date']) && in_array($date_C, $value['vacation_date'])){
                        if(in_array($date_C, $value['vacation_date'])){
                            if(in_array($ve_value, $value['vacation_time'][$date_C])){
                                ...
                                $calendar_html .= '<li class="active '.$cls_hi.' "> <div class="sch-slot" id="'.$date.'">'.$ve_value.'</div></li>';
                            }
                        }
                        ...
                        $calendar_html .='<li class="active '.$cls_hi.'"><div class="sch-slot"> '.$ve_value.'</div></li>';
                    }
                    }else{
                        $calendar_html .= '<li class="active '.$cls_hi.'"><div class="sch-slot"> '.$ve_value.'</div></li>';
                    }
