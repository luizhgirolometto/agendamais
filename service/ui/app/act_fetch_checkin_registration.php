...
<tr style="display:none" class="datas">
	<td colspan="3">
		<div class="col-md-4 col-sm-4 col-xs-12">
			<input  type="text" name="fname" value="<?php echo $Data[fname]?>" maxlength="30" placeholder="First Name"/>
		</div>
		<div class="col-md-4 col-sm-4 col-xs-12">
			<input  type="text" name="mname" value="<?php echo $Data[mname]?>" maxlength="30"placeholder="Middle Name">
		</div>
		<div class="col-md-4 col-sm-4 col-xs-12">
			<input  type="text" name="lname" value="<?php echo $Data[lname]?>" maxlength="30" placeholder="Last Name"/>
		</div>
		<div class="col-md-4 col-sm-4 col-xs-12">
			<input  type="button" value="submit" class="save submit_button " />
		</div>
		<div class="col-md-4 col-sm-4 col-xs-12">
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="text" name="ssn" maxlength="30" placeholder="Social Security Number" value="<?php echo $Data[ssn];?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="text" name="occupation" maxlength="30" placeholder="Occupation" value="<?php echo $Data[occupation];?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="text" name="email" maxlength="30" placeholder="Email ID" value="<?php echo $Data[email];?>"/>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="row">
		<div class="col-md-3 col-sm-3 col-xs-12">
			<textarea name="pAddress" rows="4" cols="30" placeholder="Address" >
				<?php echo $Data[pAddress];?>
			</textarea>
		</div>
		<div class="col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="pCity" maxlength="30" placeholder="City" value="<?php echo $Data[pCity];?>" />
		</div>
		<div class="col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="pPin" maxlength="30" placeholder="Pincode" value="<?php echo $Data[pPin];?>"/>
		</div>
		<div class="col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="pstate" maxlength="30" placeholder="State" value="<?php echo $Data[pstate];?>" />
		</div>
	</div>
	<div class="row">
		<div class="col-md-4 col-sm-4 col-xs-12">
...
<td colspan="3">
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input type="text" name="pnum" maxlength="30" placeholder="Mobile Number" value="<?php echo $Data[pnum];?>"/>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input type="text" name="hnum" maxlength="30" placeholder="Home Number" value="<?php echo $Data[hnum];?>"/>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="text" name="pcp" maxlength="30" placeholder="Primary Care Physician" value="<?php echo $Data[pcp];?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="text" name="pcpn" maxlength="30" placeholder="Primary Care Physician Number" value="<?php echo $Data[pcpn];?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="text" name="reff" maxlength="30" placeholder="Reffered By" value="<?php echo $Data[reff];?>"/>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="text" name="phar" maxlength="30" placeholder="Pharmacy" value="<?php echo $Data[phar];?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="text" name="phnum" maxlength="30" placeholder="Pharmacy Number" value="<?php echo $Data[phnum];?>" />
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
...
<td colspan="3">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<textarea name="phAddress" rows="4" cols="30" placeholder="Pharmacy Address" ><?php echo $Data[phAddress];?></textarea>
	</div>
	<div class="col-md-4 col-sm-4 col-xs-12">
		<input type="button" value="submit" class="save submit_button " />
	</div>
	...
	<div class="conform_button conform_click lg_btn col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-4 col-xs-offset-0 col-xs-12">Save</div>