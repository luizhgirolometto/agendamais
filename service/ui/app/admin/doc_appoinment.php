...
$result = $scad->apnt_details_with_docname();
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                    	...
                    	?>
                        <tr>
                        <td><?php echo $value['apnt_starttime'];?></td>
                        <td><?php echo $value['apnt_endtime'];?></td>
                        <td><?php echo $value['apnt_date'];?></td>
                        <td><?php echo $value['doc_name'];?></td>
                        <td><?php echo $value['patient_name'];?></td>
                        <td><?php echo $value['illness'];?></td>
                        <td><?php echo $value['apnt_note'];?></td>
