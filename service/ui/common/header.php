...
<body>
    ...
    <div class="header">
        <div class="container">
            <div class="col-md-12">
                <div class="col-md-8">
                    <a href="<?php echo WEB_ROOT?>"><div class="logo2"></div></a>
                </div>
                <div class="col-md-4">
                        <?php if($_SESSION['userID']){ 
                          $url = ($_SESSION['userType'] == 1) ? WEB_ROOT.'index.php/doctor/profile' : WEB_ROOT.'index.php/patient/profile'?>
                            ...
                            <div class="signup">
                             <div class="sign">
                                 ...
                                 <a href="<?php echo $url;?>"><p>Olá <?php echo (strlen($_SESSION['name']) > 6) ? substr($_SESSION['name'],0,6).'...' : $_SESSION['name']; ?></p></a>
                              </div>
                            </div>
                            <div class="signup">
                             <div class="sign">
                                 <img width="24px" height="24px" src="<?php echo WEB_ROOT?>service/public/images/images/logout.png">
                                 <a href="<?php echo WEB_ROOT?>index.php/signout"><p>Sair</p></a>
                              </div>
                            </div>
                           <?php //}else{ ?>
                         ...
                         <div class="signup">
                             <div class="sign">
                                 ...
                                 <a href="<?php echo WEB_ROOT?>index.php/join"><p>Cadastrar</p></a>
                              </div>
                          </div>
                          <div class="signin">
                            <div class="sign">
                              <img src="<?php echo WEB_ROOT?>service/public/images/images/signin.png"><a href="<?php echo WEB_ROOT?>index.php/signin "><p>Login </p></a>
                            </div>
                          </div>
                          <?php } ?>
